...
function Testimonials(){
    return(
        <motion.div initial={{opacity:0, x:100}} transition={{duration: 1}} whileInView={{opacity: 1, x:0}} viewport={{once: true}} className="container mx-auto py-10 lg:px-32 w-full overflow-hidden" id="Testimonials"> 
            ...
            testimonialsData.map(function(testimonial,index){
                return <div key = {index} className="max-w-[340px] border shadow-lg rounded px-8 py-12 text-center">
                    ...
                    <div className="flex justify-center gap-1 text-red-500 mb-4">
                        {
                            Array.from({length: testimonial.rating},function(item,index){
